namespace Meal_Planner.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MealModels", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.IngredientModels", "Meal_Id", "dbo.MealModels");
            ...
            DropIndex("dbo.MealModels", new[] { "User_Id" });
            DropIndex("dbo.IngredientModels", new[] { "Meal_Id" });
